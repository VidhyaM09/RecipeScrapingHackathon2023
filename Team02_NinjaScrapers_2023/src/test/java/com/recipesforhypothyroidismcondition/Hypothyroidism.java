...
public class Hypothyroidism extends BaseClass {
	...
	public void recipeScrapingForHypothyroidism() throws Throwable {
		...
		for (int i = 1; i <= numberOfPages; i++) {
			driver.navigate().to("https://www.tarladalal.com/recipes-for-hypothyroidism-veg-diet-indian-recipes-849?pageindex=" + i);
			...
			for (int j = 0; j < noOfRecipes; j++) {
				...
				String text = tesseract.doOCR(
						new File(System.getProperty("user.dir") + "/src/test/resources/images/hypothyroidRecipe.PNG"));
				...
				String[][] ExcludeCode = HypothyroidismExcelReader.getData("Sheet1");
